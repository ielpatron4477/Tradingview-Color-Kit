...
// ── CLASSIC (6 new) ───────────────────────────────────────────────────────────
Th("parchment","CLASSIC","PARCHMENT","Aged Paper · Manuscript · Warm Silence",
  "#f4edd8","#faf6e8","#2c1808","#8c4818","#f4edd8","#2c1808","#8c4818","#ede4cc",
  P("#987018","#983828","#187040","#402878"),P("#c89820","#c82828","#20a850","#6020b0")),

Th("cobaltblue","CLASSIC","COBALT BLUE","Electric Blue · Precise · Technical",
  "#060814","#0c1020","#b8d0f0","#2858c8","#b8d0f0","#c83028","#2858c8","#080c18",
  P("#9898a8","#2858c8","#28a0a0","#5048b0"),P("#d8d8e8","#2878f0","#28d0c8","#7848f0")),

Th("mahogany","CLASSIC","MAHOGANY","Dark Wood · Refined · Old Money",
  "#0e0604","#160c08","#e8c8a0","#a05020","#e8c8a0","#c83020","#a05020","#120806",
  P("#c09020","#c03020","#208850","#603080"),P("#e8b828","#e82820","#28c868","#9030c0")),

Th("mist","CLASSIC","MIST","Fog · Neutral · Soft Edge",
  "#0c1018","#141820","#c8d8e8","#7898b8","#c8d8e8","#c87858","#7898b8","#101418",
  P("#9898a8","#b87858","#38a8a0","#6858a8"),P("#c8c8d8","#d89868","#48d8c8","#9878e0")),

Th("walnut","CLASSIC","WALNUT","Brown · Warm Dark · Natural Grain",
  "#0c0804","#180e08","#d8b888","#906028","#d8b888","#c03818","#906028","#140c06",
  P("#b09020","#c03818","#208858","#603080"),P("#d8b028","#e84018","#28c870","#9030c0")),

Th("glacier","CLASSIC","GLACIER","Ice Blue · Cold Precision · Arctic Calm",
  "#080c12","#0c1018","#c0d8f0","#5090d0","#c0d8f0","#c05828","#5090d0","#0a0e16",
  P("#8898a8","#5090d0","#30a8a8","#5050a8"),P("#b8c8e0","#3098f0","#38d0d0","#7858e8")),

// ── NEON (2 new) ──────────────────────────────────────────────────────────────
Th("neonpeach","NEON","NEON PEACH","Warm Glow · Soft Neon · Sunset Rave",
  "#100808","#181010","#ff9870","#ff6040","#ff9870","#40f0d0","#ff6040","#140c0c",
  P("#f8c030","#ff6040","#30e890","#c030f0"),P("#fff030","#ff8050","#30f8a8","#e030f0")),

Th("vaporwave","NEON","VAPORWAVE","80s · Retro Neon · Digital Dream",
  "#0c0818","#140c24","#ff80c8","#e040a0","#ff80c8","#40d0f8","#e040a0","#100a20",
  P("#d8c030","#e040a0","#30c8f8","#b030f0"),P("#f8e030","#f840b8","#30e8f8","#d030f0")),

// ── ANIME (2 new) ─────────────────────────────────────────────────────────────
Th("spirited","ANIME","SPIRITED","Miyazaki · Lush · Spirit World",
  "#0a1008","#101808","#d0f0a8","#78c040","#d0f0a8","#f89830","#78c040","#0c1409",
  P("#c8b828","#f89830","#78c040","#6838a0"),P("#f0e028","#f8b030","#98f040","#8840e0")),

Th("cyberpunk2","ANIME","CYBER BLADE","Neon City · Rain · Night Run",
  "#040810","#080c18","#f8e830","#e0c000","#f8e830","#f03080","#e0c000","#060a14",
  P("#e0c000","#f03080","#00e8d8","#8000f0"),P("#f8f030","#f840a0","#00f8e8","#b000f0")),

// ── GOTH (2 new) ──────────────────────────────────────────────────────────────
Th("vampire","GOTH","VAMPIRE","Blood · Eternal Night · Crimson Veil",
  "#080004","#100008","#f8c0c8","#e03050","#f8c0c8","#c8a000","#e03050","#0c0006",
  P("#b89820","#e03050","#208870","#702888"),P("#e8c030","#f83060","#28c888","#a028c0")),

Th("coven","GOTH","COVEN","Dark Magic · Ritual · Hex Circle",
  "#080414","#0c0820","#d8b0f8","#9040d8","#d8b0f8","#40c880","#9040d8","#0a0618",
  P("#a89830","#9040d8","#40c880","#6030a8"),P("#d8c838","#b050f8","#40f898","#8840e8")),

// ── FREAK (2 new) ─────────────────────────────────────────────────────────────  
Th("glitchcore","FREAK","GLITCH CORE","Data Corrupt · Error · System Break",
  "#040814","#080c1c","#00ffff","#00cc88","#ff00ff","#ff0044","#00cc88","#060a18",
  P("#ccff00","#ff0044","#00ffaa","#cc00ff"),P("#ffff00","#ff4400","#00ffcc","#ff00ff")),

Th("acidpop","FREAK","ACID POP","Trippy · Oversaturated · Kaleidoscope",
  "#080010","#0c0018","#ff40ff","#cc00cc","#ff40ff","#40ff40","#cc00cc","#0a0014",
  P("#ffcc00","#cc00cc","#00ff88","#8800ff"),P("#ffff00","#ff00ff","#00ffaa","#aa00ff")),
...
const NEW_KITS_RELEASE = {
  ...
  // May 2026 batch 1
  burgundy:1777420800000, terra:1777420800000, arctic:1777420800000, onyx:1777420800000, dawnrise:1777420800000,
  casino:1777420800000, radioactive:1777420800000, hacker:1777420800000,
  institutional:1777420800000, quant:1777420800000,
  dragonball:1777420800000, hunterx:1777420800000,
  bubblegum2:1777420800000, watermelon:1777420800000,
  polarnight:1777420800000, sahara:1777420800000,
  // May 2026 batch 2
  parchment:1778025600000, cobaltblue:1778025600000, mahogany:1778025600000, mist:1778025600000, walnut:1778025600000, glacier:1778025600000,
  neonpeach:1778025600000, vaporwave:1778025600000, spirited:1778025600000, cyberpunk2:1778025600000,
  vampire:1778025600000, coven:1778025600000, glitchcore:1778025600000, acidpop:1778025600000,
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:999,background:"rgba(0,0,0,0.88)",display:"flex",alignItems:"center",justifyContent:"center",padding:24}} onClick={onClose}>
      <div style={{background:"#0a0a12",borderRadius:24,padding:28,border:"1px solid rgba(255,255,255,0.08)",maxWidth:800,width:"100%",animation:"fadeUp 0.3s ease"}} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{marginTop:16,fontSize:11,fontFamily:"'JetBrains Mono',monospace",color:"#666",textAlign:"center",letterSpacing:"0.1em"}}>Select a second kit from the grid to compare</div>
      </div>
    </div>
  );
}
...
function LiveChart({th,fam,candleStyle='candles'}){
  ...
  return(
    <div style={{borderRadius:10,overflow:"hidden",background:th.bg,border:"1px solid rgba(255,255,255,0.06)",position:"relative"}}>
      ...
      <div style={{padding:"4px 10px",fontSize:8,fontFamily:"'JetBrains Mono',monospace",color:"#555",letterSpacing:"0.1em",background:"rgba(0,0,0,0.15)"}}>ANIMATED PREVIEW · {th.name}</div>
    </div>
  );
}
    ...
    <div style={{position:"fixed",inset:0,zIndex:999,background:"rgba(0,0,0,0.94)",display:"flex",flexDirection:"column",animation:"fadeUp 0.3s ease"}} onClick={onClose}>
      <div style={{display:"flex",alignItems:"center",gap:16,padding:"14px 24px",borderBottom:"1px solid rgba(255,255,255,0.06)"}} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
          <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:"#555",letterSpacing:"0.1em"}}>STYLE</span>
          ...
          <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:"#555",letterSpacing:"0.1em"}}>ZOOM</span>
          {[0.5,1,1.5,2].map(z=>(
...
const CHANGELOG = [
  { version:"2.0", date:"Apr 2026", items:[
    "🏆 129 kits total — 30 new added in May 2026 (BURGUNDY, TERRA, ARCTIC, ONYX, DAWN RISE, CASINO, RADIOACTIVE, HACKER, INSTITUTIONAL, QUANT, DRAGON BALL, HUNTER X, DOUBLE BUBBLE, WATERMELON, POLAR NIGHT, SAHARA)",
...
function AccessibilityHeatmap({th,fam}){
  ...
  return(
    <div style={{marginTop:12}}>
      <div style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:"#666",letterSpacing:"0.2em",marginBottom:8}}>CONTRAST HEATMAP</div>
...
function Screensaver({themes,onExit}){
  ...
  return(
    <div onClick={onExit} style={{position:"fixed",inset:0,zIndex:9999,background:bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",cursor:"pointer",transition:"background 1.5s ease"}}>
      ...
      <div style={{position:"absolute",bottom:24,fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:"#666",letterSpacing:"0.2em"}}>TAP ANYWHERE TO EXIT</div>
    </div>
  );
}
        ...
        <div style={{padding:'8px 18px',borderTop:'1px solid rgba(255,255,255,0.04)',display:'flex',gap:16,alignItems:'center'}}>
          {[['↑↓','Navigate'],['↵','Select'],['esc','Close']].map(([k,d])=>(
            <div key={k} style={{display:'flex',alignItems:'center',gap:5}}>
              ...
              <span style={{fontSize:10,color:'#666',fontFamily:"'JetBrains Mono',monospace"}}>{d}</span>
            </div>
          ))}
        </div>
      </div>
...
export default function App(){
  ...
  const copyAll=()=>{
    ...
    showToast('📋 Copied ' + (lines.length-1) + ' values — paste with Ctrl+V / ⌘V');
  };
    ...
    <div style={{minHeight:"100vh",background:site.bg,position:"relative",transition:"background 0.3s"}}>
          ...
          <div className="ticker-inner">
            {[...THEMES,...THEMES].map((t,i)=>(
              <div key={i} onClick={()=>setTheme(t.id)} style={{display:"inline-flex",alignItems:"center",gap:6,padding:"0 20px",cursor:"pointer",opacity:th.id===t.id?1:0.35,transition:"opacity 0.2s"}} onMouseEnter={e=>e.currentTarget.style.opacity="0.8"} onMouseLeave={e=>e.currentTarget.style.opacity=th.id===t.id?"1":"0.35"}>
                ...
                <span style={{fontSize:8,color:"#555",fontFamily:"'JetBrains Mono',monospace",marginLeft:2}}>{CAT_META[t.cat]?.label||""}</span>
                <span style={{color:"#666",margin:"0 8px",fontSize:8}}>·</span>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="nav-inner" style={{padding:"0 52px",display:"flex",alignItems:"center",height:64,gap:16,maxWidth:1500,margin:"0 auto"}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div className="hide-mobile">
                ...
                <div style={{fontSize:9,color:"#666",letterSpacing:"0.22em",fontFamily:"'JetBrains Mono',monospace",marginTop:1}}>BY aSian · 129 KITS</div>
              </div>
            </div>
            {/* Search */}
            ...
            {showSearchHist&&searchHistory.length>0&&!search&&(
              <div style={{position:"absolute",top:"100%",left:0,right:0,marginTop:4,background:"rgba(10,10,20,0.97)",borderRadius:12,border:"1px solid rgba(255,255,255,0.08)",overflow:"hidden",zIndex:200,boxShadow:"0 8px 32px rgba(0,0,0,0.5)"}}>
                <div style={{padding:"6px 10px",fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:"#555",letterSpacing:"0.15em",borderBottom:"1px solid rgba(255,255,255,0.04)"}}>RECENT SEARCHES</div>
                {searchHistory.map(h=>(
                  <div key={h} onClick={()=>{setSearch(h);setShowSearchHist(false);}} style={{padding:"9px 14px",cursor:"pointer",display:"flex",alignItems:"center",gap:8,transition:"background 0.1s"}}
                    ...
                    <span onClick={e=>{e.stopPropagation();setSearchHistory(prev=>{const n=prev.filter(x=>x!==h);try{localStorage.setItem('tck-search-hist',JSON.stringify(n));}catch{}return n;});}} style={{marginLeft:"auto",color:"#555",fontSize:12,cursor:"pointer",padding:"0 4px"}}>✕</span>
                  </div>
                ))}
              </div>
            )}
            ...
            <button onClick={()=>setShowCmd(true)} style={{padding:"7px 12px",background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:20,color:"#333",fontSize:10,fontFamily:"'JetBrains Mono',monospace",cursor:"pointer",letterSpacing:"0.08em",display:"flex",alignItems:"center",gap:6}} className="hide-mobile">
              <span>⌕</span><span>Search</span><kbd style={{padding:"1px 5px",borderRadius:4,background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.08)",fontSize:9,color:"#555",fontFamily:"'JetBrains Mono',monospace"}}>⌘K</kbd>
            </button>
        ...
        <div className="main-pad" style={{padding:"72px 52px 48px",maxWidth:1500,margin:"0 auto"}}>
          <div className="hero-grid" style={{display:"grid",gridTemplateColumns:"1fr",gap:60,alignItems:"center",marginBottom:64}}>
            <div className="fade-up">
              ...
              <p style={{fontSize:15,color:"#3a3a3a",maxWidth:460,lineHeight:1.7,fontFamily:"'Space Grotesk',sans-serif",marginBottom:32}}>129 curated color systems for TradingView. Key Levels, ICT/SMC, Fibonacci, VWAP, nPOC and more. Click any color to copy.</p>
              {/* Trending */}
              <div style={{marginBottom:24}}>
                <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:8}}><span style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:"#888",letterSpacing:"0.18em"}}>🔥 TRENDING</span></div>
                <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
            ...
            <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:12}}>
              {(()=>{const kt=THEMES.find(t=>t.id===kotd);if(!kt)return null;return(
                <button onClick={()=>setTheme(kotd)} style={{display:"flex",alignItems:"center",gap:8,padding:"7px 12px",borderRadius:12,background:"rgba(0,0,0,0.6)",border:"1px solid rgba(255,215,0,0.4)",cursor:"pointer"}}>
                  <span style={{fontSize:13}}>🏆</span>
                  <div><div style={{fontSize:7,fontFamily:"'JetBrains Mono',monospace",color:"#d4a000",letterSpacing:"0.2em"}}>KIT OF THE DAY</div><div style={{fontSize:10,fontFamily:"'Space Grotesk',sans-serif",fontWeight:700,color:"#d4a800"}}>{kt.name}</div></div>
                </button>
              );})()}
              {(()=>{const st=THEMES.find(t=>t.id===seasonal.id);if(!st)return null;return(
                <button onClick={()=>setTheme(seasonal.id)} style={{display:"flex",alignItems:"center",gap:8,padding:"7px 12px",borderRadius:12,background:"rgba(0,0,0,0.6)",border:`1px solid ${seasonal.color}60`,cursor:"pointer"}}>
                  <span style={{fontSize:13}}>🌟</span>
                  <div><div style={{fontSize:7,fontFamily:"'JetBrains Mono',monospace",color:seasonal.color,letterSpacing:"0.18em",opacity:1}}>SEASONAL</div><div style={{fontSize:10,fontFamily:"'Space Grotesk',sans-serif",fontWeight:700,color:seasonal.color}}>{seasonal.label}</div></div>
                </button>
              );})()}
            ...
            {recent.filter(id=>id!==activeTheme).slice(0,5).length>0&&(
              <div style={{marginBottom:12}}>
                <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:6}}><span style={{fontSize:8,fontFamily:"'JetBrains Mono',monospace",color:"#666",letterSpacing:"0.15em"}}>⏱ RECENTLY VIEWED</span></div>
                <div style={{display:"flex",gap:5,flexWrap:"wrap"}}>
                  {recent.filter(id=>id!==activeTheme).slice(0,5).map(id=>{const t=THEMES.find(x=>x.id===id);if(!t)return null;return(
                    <button key={id} onClick={()=>setTheme(id)} style={{display:"flex",alignItems:"center",gap:5,padding:"4px 9px",borderRadius:16,background:"rgba(0,0,0,0.7)",border:`1px solid ${t.ac}60`,cursor:"pointer"}}>
                      <div style={{width:8,height:8,borderRadius:2,background:t.up,flexShrink:0}}/>
          ...
          <div className="kit-grid" style={{display:gridCollapsed?"none":"grid",gridTemplateColumns:"repeat(auto-fill,minmax(130px,1fr))",gap:9,marginBottom:14}} onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
            {displayed.length===0&&<div style={{gridColumn:"1/-1",textAlign:"center",padding:"48px 0",color:"#555",fontFamily:"'JetBrains Mono',monospace",fontSize:12}}>No kits found. <button onClick={()=>{setSearch("");setFilter("ALL");setShowFavs(false);}} style={{color:th.ac,background:"none",border:"none",cursor:"pointer",fontFamily:"inherit",fontSize:"inherit"}}>Clear filters</button></div>}
            {displayed.map((t,_i)=>{
            ...
            <div className="sticky-card" style={{position:"sticky",top:80}}>
              <div key={th.id} className="kit-slide slide-left glass-deep glass-shimmer" style={{borderRadius:24,...glassStyle,overflow:"hidden",boxShadow:glow?`0 24px 80px rgba(0,0,0,0.6), 0 0 60px ${th.ac}15`:"0 24px 60px rgba(0,0,0,0.5)"}}>
                ...
                <div style={{padding:"32px 28px 24px"}}>
                  ...
                  <div style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:"#666",letterSpacing:"0.1em",marginBottom:24}}>{th.tag.toUpperCase()}</div>
          ...
          {/* KITS LIKE THIS */}
          {getSimilar(th,palette,4).filter(t=>filter==='ALL'||filter==='FAVS'||t.cat===filter).map(t=>{const f=t[palette]||t.match;const tg=["NEON","VIBE","DEGEN","CYBER","FREAK","AURA","GUM","FREE","ANIME","MEME"].includes(t.cat);const bg=SBGS[t.id]||PHANTOM_SBGS[t.id]||t.bg;const r=getContrast(t.up,t.bg);const b=contrastBadge(r);return null;}).filter(Boolean).length>0&&(
            <div style={{marginBottom:48}}>
              <div style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:"#666",letterSpacing:"0.25em",marginBottom:14}}>✦ KITS LIKE THIS</div>
          ...
          <div style={{borderTop:"1px solid rgba(255,255,255,0.04)",marginTop:80,padding:"28px 0",display:"flex",alignItems:"center",gap:14,flexWrap:"wrap"}}>
            ...
            <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:"#666",letterSpacing:"0.15em"}}>TRADING COLOR KITS · 129 THEMES · 16 CATEGORIES</span>
            <div style={{flex:1}}/>
      ...
      {scrollY>300&&(
        <div style={{position:"fixed",top:76,right:16,zIndex:500,padding:"7px 12px",borderRadius:20,background:"rgba(8,8,18,0.92)",border:"1px solid rgba(255,255,255,0.1)",backdropFilter:"blur(16px)",display:"flex",alignItems:"center",gap:8,boxShadow:"0 4px 20px rgba(0,0,0,0.5)",animation:"fadeIn 0.2s ease",cursor:"pointer"}}
          ...
          <span style={{fontSize:8,fontFamily:"'JetBrains Mono',monospace",color:"#555"}}>↑</span>
        </div>
      )}
