...
export default function App(){
  ...
  const[showChangelog,setShowChangelog]=useState(()=>{try{return localStorage.getItem('tck-cl-ver')!==CHANGELOG_VERSION;}catch{return true;}});
  ...
  return(
    <div style={{minHeight:"100vh",background:site.bg,position:"relative",transition:"background 0.3s"}}>
      ...
      {showChangelog&&<ChangelogModal onClose={()=>{setShowChangelog(false);try{localStorage.setItem('tck-cl-ver',CHANGELOG_VERSION);}catch{}}} ac={th.ac}/>}
      <Toast msg={toast}/>
    </div>
  );
}
