                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,marginBottom:24}}>
                  {Object.entries(th.chart).map(([k,s])=>(
                    <div key={k} style={{display:"flex",flexDirection:"column",gap:6,alignItems:"center"}}>
                      <div style={{width:"100%",height:36,borderRadius:10,background:s.hex,boxShadow:glow?`0 0 14px ${s.hex}50`:"0 2px 8px rgba(0,0,0,0.3)",border:"1px solid rgba(255,255,255,0.08)"}}/>
                      <span style={{fontSize:9,fontFamily:"'JetBrains Mono',monospace",color:"#333",textAlign:"center"}}>{s.label.split(" ").slice(0,2).join(" ")}</span>
                    </div>
                  ))}
                </div>
