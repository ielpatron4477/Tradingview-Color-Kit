          ...
          <div className="nav-inner" style={{padding:"0 52px",display:"flex",alignItems:"center",height:64,gap:16,maxWidth:1500,margin:"0 auto"}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div className="hide-mobile">
                ...
                <div style={{fontSize:9,color:"#666",letterSpacing:"0.22em",fontFamily:"'JetBrains Mono',monospace",marginTop:1}}>BY aSian · 125 KITS</div>
              </div>
            </div>
            {/* Search */}
        ...
        <div className="main-pad" style={{padding:"72px 52px 48px",maxWidth:1500,margin:"0 auto"}}>
          <div className="hero-grid" style={{display:"grid",gridTemplateColumns:"1fr",gap:60,alignItems:"center",marginBottom:64}}>
            <div className="fade-up">
              ...
              <p style={{fontSize:15,color:"#3a3a3a",maxWidth:460,lineHeight:1.7,fontFamily:"'Space Grotesk',sans-serif",marginBottom:32}}>125 curated color systems for TradingView. Key Levels, ICT/SMC, Fibonacci, VWAP, nPOC and more. Click any color to copy.</p>
              {/* Trending */}
          ...
          <div style={{borderTop:"1px solid rgba(255,255,255,0.04)",marginTop:80,padding:"28px 0",display:"flex",alignItems:"center",gap:14,flexWrap:"wrap"}}>
            ...
            <span style={{fontSize:10,fontFamily:"'JetBrains Mono',monospace",color:"#666",letterSpacing:"0.15em"}}>TRADING COLOR KITS · 125 THEMES · 16 CATEGORIES</span>
            <div style={{flex:1}}/>
